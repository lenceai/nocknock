"""
Configuration management for WTM (World Truth Model)
"""
import yaml
...
class Config:
    ...
    def load(cls, config_path: str) -> 'Config':
        ...
        try:
            ...
            if 'wtm' in data:
                for key, value in data['wtm'].items():
                    if hasattr(config.wtm, key):
                        setattr(config.wtm, key, value)
